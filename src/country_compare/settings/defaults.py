...
DEFAULT_PREDICTION_HORIZON_YEARS = 3
DEFAULT_PREDICTION_FORECAST_HORIZON = 1
DEFAULT_PREDICTION_HOLDOUT_YEARS = 2
DEFAULT_MAX_PREDICTION_HOLDOUT_YEARS = 10

DEFAULT_LLM_SERVICE_URL = ""
DEFAULT_LLM_SERVICE_TOKEN = ""
DEFAULT_LLM_SERVICE_TIMEOUT_SECONDS = 25
DEFAULT_LLM_MAX_SERIES_PER_REQUEST = 3
DEFAULT_ENABLE_LLM_FORECAST = False
DEFAULT_LLM_PROVIDER = ""
DEFAULT_LLM_MODEL = ""
DEFAULT_LLM_TIMEOUT_SECONDS = 20
DEFAULT_LLM_MAX_RETRIES = 1
DEFAULT_LLM_BASELINE_METHOD = "holt_linear"
DEFAULT_LLM_MAX_HISTORY_POINTS = 40
DEFAULT_LLM_MAX_ADJUSTMENT_PCT = 20.0
