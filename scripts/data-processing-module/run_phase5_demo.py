...
def main() -> None:
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        print('merge ok:', conflict_result.merge_report.ok if conflict_result.merge_report else None)
        print(
            'duplicate conflicts:',
            conflict_result.merge_report.duplicate_key_conflict_count if conflict_result.merge_report else None,
        )
        ...
        checks = {
            ...
            'audit_written': bool(success_result.audit_report and success_result.audit_report.written),
            'manifest_tags_propagated': bool(success_result.source_results and success_result.source_results[0].tags == ('demo', 'batch')),
            'merge_conflict_detected': bool(conflict_result.merge_report and conflict_result.merge_report.duplicate_key_conflict_count == 1),
        }
