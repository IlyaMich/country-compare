...
def main() -> None:
    ...
    views = {
      OVERVIEW_PAGE: lambda: render_overview_page(facade, debug=state.snapshot().debug_mode),
    ...
    with st.sidebar:
        ...
        debug_mode = st.checkbox(DEBUG_CHECKBOX_LABEL, value=current_snapshot.debug_mode)
